...
import 'package:meentenda/screens/products/components/product_list_tile.dart';
import 'package:meentenda/screens/products/components/search_dialog.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        title: Consumer<ProductManager>(
          builder: (_, productManager, __){
            if (productManager.search.isEmpty){
              return const Text('Todos os Sentimentos');
            } else {
          ...
          Consumer<UserManager>(
            builder: (_, userManager, __){
              if(userManager.adminEnabled){
                return IconButton(
                    icon: Icon(Icons.library_add_outlined, color: Colors.transparent,),
                    onPressed: (){
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(Icons.shopping_cart_outlined, color: Colors.transparent,),
        elevation: 0,
